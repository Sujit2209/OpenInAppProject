...
object ApiModule {
    ...
    @Provides
    @Singleton
    //Implements an Instance of the modern Moshi library for JSON parsing
    ...
    @Provides
    @Singleton
    //It is responsible for creating an singleton instance for API service using the base url and parse the JSON format
